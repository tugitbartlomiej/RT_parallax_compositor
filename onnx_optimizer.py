...
def allocate_buffers(engine):
    input_binding_name = engine.get_tensor_name(0)  # Get the name of the first binding
    output_binding_name = engine.get_tensor_name(1)  # Get the name of the second binding
